          ...
          <Card className="shadow-sm border border-gray-200 bg-gradient-to-r from-violet-50 to-indigo-50">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="text-center p-3 bg-white/50 rounded-lg">
                ...
                <Text strong className="block">{form.getFieldValue('role') || role}</Text>
              ...
              <div className="text-center p-3 bg-white/50 rounded-lg">
                ...
                <Text strong className="block">
                  {getQuestionCount(form.getFieldValue('duration') || duration)} Questions
                </Text>
              ...
              <div className="text-center p-3 bg-white/50 rounded-lg">
                ...
                <Text strong className="block">
                  {complexityModes.find(m => m.value === (form.getFieldValue('complexity') || complexity))?.label.replace(/[🎯📚🔥📄]/g, '').trim()}
                </Text>
              ...
              <div className="text-center p-3 bg-white/50 rounded-lg">
                ...
                <Text strong className="block">
                  {focusAreas.find(f => f.value === (form.getFieldValue('focusArea') || focusArea))?.label}
                </Text>
